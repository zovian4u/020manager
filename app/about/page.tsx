...
export default function AboutUs() {
    ...
    return (
        <main className="min-h-screen bg-slate-900 px-6 pb-20 relative overflow-hidden">
            {/* Spacer for MenuBar */}
            ...
            <div className="relative z-10 max-w-6xl mx-auto">
                <header className="text-center mb-24">
                    <h1 className="text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500 uppercase italic tracking-tighter drop-shadow-2xl">
                        {t('aboutUs')}
                    </h1>
                        ...
                        {orderedRoles.map((role) => (
                            <section key={role} className="relative">
                                ...
                                <div className="flex items-center gap-6 mb-12">
                                    ...
                                    <h2 className="text-3xl font-black text-white uppercase italic tracking-widest drop-shadow-[0_0_15px_rgba(255,255,255,0.3)]">
                                        Rank {role}
                                    </h2>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
                                    {groupedMembers[role].map((member, i) => (
                                        <div
                                            key={member.user_id}
                                            className="group relative bg-white/5 backdrop-blur-md border border-white/10 p-6 rounded-3xl hover:-translate-y-2 transition-transform duration-500 hover:shadow-[0_20px_40px_-20px_rgba(236,72,153,0.3)]"
                                        >
                                            ...
                                            <div className="text-center relative z-10">
                                                ...
                                                <p className="text-[10px] text-pink-400 font-bold uppercase tracking-widest">
                                                    PWR: {((member.total_hero_power || 0) / 1000000).toFixed(1)}M
                                                </p>
                                            </div>
                                        </div>
                                    ))}
